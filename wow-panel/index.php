...
<div id="toppanel">
		...
		<div class="content clearfix">
			...
			<div class="left right">			
				...
				<form action="" method="post">
					<h1>Sie sind nicht Spieler bei <? echo $servername; ?>?</h1>		
            ...
            <p><a href="<?php echo $quicklinks["http_link1"];?>"><?php echo $quicklinks["name_link1"]; ?></a></p>
            <p><a href="<?php echo $quicklinks["http_link2"];?>"><?php echo $quicklinks["name_link2"]; ?></a></p>
            <p><a href="<?php echo $quicklinks["http_link3"];?>"><?php echo $quicklinks["name_link3"]; ?></a></p>
            <p><a href="<?php echo $quicklinks["http_link4"];?>"><?php echo $quicklinks["name_link4"]; ?></a></p>
            <p><a href="<?php echo $quicklinks["http_link5"];?>"><?php echo $quicklinks["name_link5"]; ?></a></p>
            <p><a href="<?php echo $quicklinks["http_link6"];?>"><?php echo $quicklinks["name_link6"]; ?></a></p>
            <!-- <p><a href="<?php echo $quicklinks["http_link7"];?>"><?php echo $quicklinks["name_link7"]; ?></a></p> -->
            <a href="?logoff">Ausloggen</a>
	...
	<div class="tab">
		<ul class="login">
	    	<li class="left">&nbsp;</li>
	        <li>Hallo <?php echo $_SESSION['usr'] ? $_SESSION['usr'] : 'Gast';?>!</li>
			<li class="sep">|</li>
			<li id="toggle">
...
<div class="pageContent">
    <div id="main">
      <div class="container">
      <center>
      Sie müssen <a href="#" onClick='$("div#panel").slideDown();$("#toggle a").toggle();'>eingeloggt</a> sein, bevor Sie diese Seite benutzen k&ouml;nnen!
      </div>
    </div>
</div>
<?
